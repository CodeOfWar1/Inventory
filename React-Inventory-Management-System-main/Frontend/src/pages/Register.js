...
function Register() {
  ...
  const registerUser = async (e) => {
    ...
    try {
      ...
      console.log(err);
      alert("Unable to register. Please check if backend is running.");
    }
  };
  // ------------------
          ...
          <form className="mt-8 space-y-6" onSubmit={registerUser}>
            ...
            <div className="flex flex-col gap-4 -space-y-px rounded-md shadow-sm">
              ...
              <div>
                <select
                  name="role"
                  className="relative block w-full rounded-b-md border-0 py-1.5 px-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  value={form.role}
                  onChange={handleInputChange}
                  required
                >
              ...
              {form.role === "designer" && (
                <div>
                  <input
                    ...
                    required
                    className="relative block w-full rounded-b-md border-0 py-1.5 px-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    placeholder="Designer Group (e.g. Group 1)"
                    value={form.designerGroup}
                    onChange={handleInputChange}
                  />
                </div>
              )}
